...
const About = () => {
    ...
    const handleCopy = ()=> {
        navigator.clipboard.writeText('goodnesstowobola@gmail.com')
        setHasCopied(true)
             ...
             <div className='col-span-1 xl:row-span-3'>
                <div className='grid-container'>
                    ...
                    <div>
                        ...
                        <p className='grid-subtext'> I specialize in Javascript
                            /TypeScript with a focus on React and Next.js Ecosystems
                        </p>
                    </div>
                </div>
             </div>
...
bumpImageUrl="//unpkg.com/three-globe/example/img/earth-topology.png"
                        ...
                        <div>
                            ...
                            <p className='grid-subtext'>I'm based in Nigeria, with remote work avaliable</p>
                ...
                <div className='xl:col-span-1 xl:row-span-2'>
                    <div className='grid-container'>
                        ...
                        alt='grid-4' className='w-full md:h-[126px]
